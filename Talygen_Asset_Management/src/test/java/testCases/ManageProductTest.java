...
public class ManageProductTest extends WebTestBase{
	...
	{
		test=getTest(Screenname + " : Validate Functionality Of In Transit Product Page with Rejection functionality");
	...
	@Test(priority =14)
	public void ValidateCheckAvabilityFunctionalityWithProductCheckOut()
	{
	...
	@Test(priority =15)
	public void ValidateCheckAvabilityFunctionalityWithRejection()
	{
		test=getTest(Screenname + " : Validate Check Avability Functionality");
